...
class Article(db.Model):
    ...
    updated = db.Column(db.DateTime,
                           ...
                           nullable=False,
                    default=datetime.datetime.now())
    author = db.Column(db.String(80),#default= g.user.email,#current_user.email,
                           nullable=False)
    category_id = db.Column(db.Integer, db.ForeignKey('articlecategory.id'))
...
class ArticleCategory(db.Model):
    ...
    """
    parent_id = db.Column(db.Integer, db.ForeignKey('articlecategory.id'))
    child = relationship("ArticleCategory",
                backref=backref('parent', remote_side=[id]))
